    ...
    private void writeRequests() throws IOException {
        ...
        if (!setRequests) {
            ...
            try {
                ...
                if (modTime != 0 ) {
                    requests.setIfNotSet("If-Modified-Since",
                            ZonedDateTime.ofInstant(Instant.ofEpochMilli(modTime),
                                ZoneId.of("GMT")).format(
                                        DateTimeFormatter.RFC_1123_DATE_TIME));
                }
            } catch(DateTimeException dtEx) {
                throw new IOException("Incorrect If-Modified-Since value", dtEx);
            }
